...
- (void)setupSettingItems {
    self.settingSections = @[
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"屏蔽评论区 AI 解析" key:@"DYYYBlockCommentAIParse" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"最高画质（HDR优先）" key:@"DYYYEnableVideoHighestQuality" type:DYYYSettingItemTypeSwitch],
